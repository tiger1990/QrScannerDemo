...
import com.airtel.barcodescanner.camera.CameraInstance;
import com.airtel.barcodescanner.camera.CameraParametersCallback;
import com.airtel.barcodescanner.camera.CameraSettings;
import com.airtel.barcodescanner.camera.CameraSurface;
import com.airtel.barcodescanner.camera.CenterCropStrategy;
import com.airtel.barcodescanner.camera.FitCenterStrategy;
import com.airtel.barcodescanner.camera.DisplayConfiguration;
import com.airtel.barcodescanner.camera.FitXYStrategy;
import com.airtel.barcodescanner.camera.PreviewScalingStrategy;
import com.airtel.core.ZoomableSurfaceView;
import com.airtel.core.ZoomableTextureView;
...
public class CameraPreview extends ViewGroup {
    ...
    private void setupSurfaceView() {
        if(useTextureView) {
            textureView = new ZoomableTextureView(getContext());
            textureView.setSurfaceTextureListener(surfaceTextureListener());
            addView(textureView);
        } else {
            surfaceView = new ZoomableSurfaceView(getContext());
